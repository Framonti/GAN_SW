...
from generate_data import generate_latent_points, generate_fake_samples


def generate_and_save_images_refactor(g_model, latent_dim, name, training, n_samples=100):  # todo remove default
